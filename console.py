...
# wine1 = wine("wine_name1", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine1)

# wine2 = wine("wine_name2", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine2)

# wine3 = wine("wine_name3", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine3)

# wine4 = wine("wine_name4", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine4)

# wine5 = wine("wine_name5", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine5)

# wine6 = wine("wine_name6", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine6)

# wine7 = wine("wine_name7", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine7)

# wine8 = wine("wine_name8", producer1, 6, 5.00, 20.00)
# wine_repository.save(wine8)

# wine9 = wine("wine_name9", producer1, 6, 5.00, 20.00)
